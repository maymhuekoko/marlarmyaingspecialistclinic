...
<div class="row">
    ...
    <div class="col-md-6 col-sm-6 mt-3">
        ...
        <button type="button" class="btn btn-sm bneonblue text-white btn-rounded float-right mb-3" data-toggle="modal" data-target="#doc_edu">
    ...
    <div class="col-md-6 col-sm-6 mt-3">
        ...
        <button type="button" class="btn btn-sm bneonblue text-white btn-rounded float-right mb-3" data-toggle="modal" data-target="#doc_exp">
            <i class="fa fa-plus"></i> Add New
        </button>
 ...
 <div class="m-t-20 text-center">
    <button class="btn bneonblue text-white" id="add_doc_btn">Create Doctor</button>
</div>
...
<script type="text/javascript">
  ...
  $('#add_doc_btn').click(function(){
      ...
      if($.trim(name) == '' || $.trim(phone) == '' || $.trim(gender) == '' || $.trim(gender) == '' || $.trim(address) == '' || $.trim(position_now) == '' || $.trim(department) == '' || $.trim(consultation) == '' || $.trim(max_token_no) == '' || $.trim(vip_token) == '' || $.trim(range) == '' || $.trim(weekormonth) == '' || $.trim(status) == '' || $.trim(email) == ''){
