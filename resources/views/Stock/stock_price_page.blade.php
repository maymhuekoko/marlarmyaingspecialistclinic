                    ...
                    <table class="table">
                        ...
                        <tbody id="units_table">
                            ...
                            <tr>
                                ...
                                <!--</td>-->
                                <td> 
                                    <a href="#" class="btn btn-outline-warning" onclick="getModal({{$unit->id}},'{{$unit->unit_name}}',{{$unit->purchase_price}},{{$unit->normal_sale_price}})">
...
<script>
    ...
    $('#unit_price').change(function(){
        ...
        let button = `<a  href="#" class="btn btn-outline-warning" onclick="getModal('${value.id}','${value.unit_name}','${value.purchase_price}','${value.normal_sale_price}')">Update</a>`;

        $('#units_table').append($('<tr>')).append($('<td>').text("")).append($('<td>').text(value.unit_name)).append($('<td>').text(value.purchase_price)).append($('<td>').text(value.normal_sale_price)).append($('<td>').append($(button)));
    ...
    function getModal(id,unit_name,purchase_price,normal_sale_price){
